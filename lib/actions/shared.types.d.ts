...
export interface CreateProjectParams {
  ...
  collaborators?: string[]; // Optional collaborator IDs
}
...
export interface UpdateProjectParams {
  ...
  collaborators?: string[]; // Updated collaborator IDs
}
...
export interface GetProjectsParams {
  ...
  filter?: string; // Optional status filter, e.g., "ongoing", "completed"
}

export interface AddApplicantParams {
  projectId: string;
...
export interface DeleteApplicantParams {
  projectId: string;
  applicantId: string; // User ID of the applicant
}
